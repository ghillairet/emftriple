...
public class BasicSesameNativeGraphTest {
	...
	public void testDeleteGraph() throws IOException {
		Resource resource = resourceSet.createResource(URI.createURI("emftriple://sesame?graph=http://graph"));
	...
	@Test
	public void testCreateAndStoreGraph() throws IOException {
		Resource resource = resourceSet.createResource(URI.createURI("emftriple://sesame?graph=http://graph"));
	...
	@Test
	public void testLoadResourceGraph() throws IOException {
		Resource resource = resourceSet.createResource(URI.createURI("emftriple://sesame?graph=http://graph"));
