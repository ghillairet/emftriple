 ...
 * <ul>
 *   <li>{@link org.eclipselabs.emftriple.junit.model.impl.PrimaryObjectImpl#getId <em>Id</em>}</li>
 *   <li>{@link org.eclipselabs.emftriple.junit.model.impl.PrimaryObjectImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.eclipselabs.emftriple.junit.model.impl.PrimaryObjectImpl#getUnsettableAttribute <em>Unsettable Attribute</em>}</li>
 *   <li>{@link org.eclipselabs.emftriple.junit.model.impl.PrimaryObjectImpl#getUnsettableAttributeWithDefault <em>Unsettable Attribute With Default</em>}</li>
 *   <li>{@link org.eclipselabs.emftriple.junit.model.impl.PrimaryObjectImpl#getUnsettableReference <em>Unsettable Reference</em>}</li>
 *   <li>{@link org.eclipselabs.emftriple.junit.model.impl.PrimaryObjectImpl#getSingleNonContainmentReference <em>Single Non Containment Reference</em>}</li>
 *   <li>{@link org.eclipselabs.emftriple.junit.model.impl.PrimaryObjectImpl#getMultipleNonContainmentReference <em>Multiple Non Containment Reference</em>}</li>
 *   <li>{@link org.eclipselabs.emftriple.junit.model.impl.PrimaryObjectImpl#getSingleContainmentReferenceNoProxies <em>Single Containment Reference No Proxies</em>}</li>
 *   <li>{@link org.eclipselabs.emftriple.junit.model.impl.PrimaryObjectImpl#getMultipleContainmentReferenceNoProxies <em>Multiple Containment Reference No Proxies</em>}</li>
 *   <li>{@link org.eclipselabs.emftriple.junit.model.impl.PrimaryObjectImpl#getSingleContainmentReferenceProxies <em>Single Containment Reference Proxies</em>}</li>
 *   <li>{@link org.eclipselabs.emftriple.junit.model.impl.PrimaryObjectImpl#getMultipleContainmentReferenceProxies <em>Multiple Containment Reference Proxies</em>}</li>
 *   <li>{@link org.eclipselabs.emftriple.junit.model.impl.PrimaryObjectImpl#getFeatureMapReferenceType2 <em>Feature Map Reference Type2</em>}</li>
 *   <li>{@link org.eclipselabs.emftriple.junit.model.impl.PrimaryObjectImpl#getFeatureMapReferenceType1 <em>Feature Map Reference Type1</em>}</li>
 *   <li>{@link org.eclipselabs.emftriple.junit.model.impl.PrimaryObjectImpl#getFeatureMapReferenceCollection <em>Feature Map Reference Collection</em>}</li>
 *   <li>{@link org.eclipselabs.emftriple.junit.model.impl.PrimaryObjectImpl#getFeatureMapAttributeType1 <em>Feature Map Attribute Type1</em>}</li>
 *   <li>{@link org.eclipselabs.emftriple.junit.model.impl.PrimaryObjectImpl#getFeatureMapAttributeType2 <em>Feature Map Attribute Type2</em>}</li>
 *   <li>{@link org.eclipselabs.emftriple.junit.model.impl.PrimaryObjectImpl#getFeatureMapAttributeCollection <em>Feature Map Attribute Collection</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PrimaryObjectImpl extends EObjectImpl implements PrimaryObject {
	...
	/**
	 * The default value of the '{@link #getUnsettableAttributeWithDefault() <em>Unsettable Attribute With Default</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @ordered
	 */
	protected static final String UNSETTABLE_ATTRIBUTE_WITH_DEFAULT_EDEFAULT = "foo";

	/**
	 * The cached value of the '{@link #getUnsettableAttributeWithDefault() <em>Unsettable Attribute With Default</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getUnsettableAttributeWithDefault()
	 * @generated
	 * @ordered
	 */
	protected String unsettableAttributeWithDefault = UNSETTABLE_ATTRIBUTE_WITH_DEFAULT_EDEFAULT;

	/**
	 * This is true if the Unsettable Attribute With Default attribute has been set.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	protected boolean unsettableAttributeWithDefaultESet;
	 ...
	 * @generated
	 */
	public void setUnsettableAttributeWithDefault(String newUnsettableAttributeWithDefault) {
		String oldUnsettableAttributeWithDefault = unsettableAttributeWithDefault;
		unsettableAttributeWithDefault = newUnsettableAttributeWithDefault;
		boolean oldUnsettableAttributeWithDefaultESet = unsettableAttributeWithDefaultESet;
		unsettableAttributeWithDefaultESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.PRIMARY_OBJECT__UNSETTABLE_ATTRIBUTE_WITH_DEFAULT, oldUnsettableAttributeWithDefault, unsettableAttributeWithDefault, !oldUnsettableAttributeWithDefaultESet));
	}
	 ...
	 * @generated
	 */
	public void unsetUnsettableAttributeWithDefault() {
		String oldUnsettableAttributeWithDefault = unsettableAttributeWithDefault;
		boolean oldUnsettableAttributeWithDefaultESet = unsettableAttributeWithDefaultESet;
		unsettableAttributeWithDefault = UNSETTABLE_ATTRIBUTE_WITH_DEFAULT_EDEFAULT;
		unsettableAttributeWithDefaultESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, ModelPackage.PRIMARY_OBJECT__UNSETTABLE_ATTRIBUTE_WITH_DEFAULT, oldUnsettableAttributeWithDefault, UNSETTABLE_ATTRIBUTE_WITH_DEFAULT_EDEFAULT, oldUnsettableAttributeWithDefaultESet));
	}
	 ...
	 * @generated
	 */
	public boolean isSetUnsettableAttributeWithDefault() {
		return unsettableAttributeWithDefaultESet;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case ModelPackage.PRIMARY_OBJECT__UNSETTABLE_ATTRIBUTE_WITH_DEFAULT:
				return getUnsettableAttributeWithDefault();
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case ModelPackage.PRIMARY_OBJECT__UNSETTABLE_ATTRIBUTE:
				...
				return;
			case ModelPackage.PRIMARY_OBJECT__UNSETTABLE_ATTRIBUTE_WITH_DEFAULT:
				setUnsettableAttributeWithDefault((String)newValue);
				return;
			case ModelPackage.PRIMARY_OBJECT__UNSETTABLE_REFERENCE:
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			...
			case ModelPackage.PRIMARY_OBJECT__UNSETTABLE_ATTRIBUTE:
				...
				return;
			case ModelPackage.PRIMARY_OBJECT__UNSETTABLE_ATTRIBUTE_WITH_DEFAULT:
				unsetUnsettableAttributeWithDefault();
				return;
			case ModelPackage.PRIMARY_OBJECT__UNSETTABLE_REFERENCE:
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			...
			case ModelPackage.PRIMARY_OBJECT__UNSETTABLE_ATTRIBUTE_WITH_DEFAULT:
				return isSetUnsettableAttributeWithDefault();
			case ModelPackage.PRIMARY_OBJECT__UNSETTABLE_REFERENCE:
	...
	public String toString() {
		...
		result.append(", unsettableAttributeWithDefault: ");
		if (unsettableAttributeWithDefaultESet) result.append(unsettableAttributeWithDefault); else result.append("<unset>");
