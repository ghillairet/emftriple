...
public class ModelPackageImpl extends EPackageImpl implements ModelPackage {
	 ...
	 * @see com.junit.model.ModelPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public void initializePackageContents() {
		...
		initEReference(getPersonBNode_Books(), this.getBookBNode(), this.getBookBNode_Authors(), "books", null, 0, -1, PersonBNode.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getBookBNode_Authors(), this.getPersonBNode(), this.getPersonBNode_Books(), "authors", null, 0, -1, BookBNode.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
