 ...
 *
 */
public class SailEmfTripleQueryResultTest extends EmfTripleQueryResultTest {

	private static final File folder;
	private static final Sail repository;
	
	static {
		folder = new File("sail-query-test");
	...
	public SailEmfTripleQueryResultTest() {
		super(new SailTestSupport("sail-query-test", repository));
	}
