 ...
 *******************************************************************************/
package org.eclipselabs.emftriple.query.result.util;
...
import org.eclipselabs.emftriple.query.result.*;
 ...
 * <!-- end-user-doc -->
 * @see org.eclipselabs.emftriple.query.result.ResultPackage
 * @generated
 */
public class ResultSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ResultPackage.QUERY_RESULT: {
				QueryResult queryResult = (QueryResult)theEObject;
				T result = caseQueryResult(queryResult);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ResultPackage.SINGLE_RESULT: {
				SingleResult singleResult = (SingleResult)theEObject;
				T result = caseSingleResult(singleResult);
				if (result == null) result = caseQueryResult(singleResult);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ResultPackage.LIST_RESULT: {
				ListResult listResult = (ListResult)theEObject;
				T result = caseListResult(listResult);
				if (result == null) result = caseQueryResult(listResult);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Single Result</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Single Result</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseSingleResult(SingleResult object) {
		return null;
	}
