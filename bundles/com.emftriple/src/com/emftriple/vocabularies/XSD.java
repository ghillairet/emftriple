 ...
 *******************************************************************************/
package com.emftriple.vocabularies;
...
public final class XSD {
	...
	public static final String xboolean = NS + "boolean";
	...
	public static final String gYearMonth = NS + "gYearMonth";
	
	public static final String gYear  = NS + "gYear";
	
	public static final String gMonthDay = NS + "gMonthDay";
	
	public static final String gDay = NS + "gDay";
	
	public static final String gMonth  = NS + "gMonth";
	
	public static final String hexBinary = NS + "hexBinary";
	
	public static final String base64Binary = NS + "base64Binary"; 
	
	public static final String anyURI = NS + "anyURI";
	
	public static final String normalizedString = NS + "normalizedString";
	...
	public static final String NCName = NS + "NCName";
